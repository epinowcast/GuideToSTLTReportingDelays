...
| NobBS | Multiplicative | Random walk | Rolling window | NegBin | No | Yes | No | No | No |
| EpiNow2 | Multiplicative | Flexible | Partial | Poisson, NegBin | Yes | Yes | Yes | No | No |
| nowcaster | Regression | Smooth | Yes | User-specified | Yes | No | No | Yes | Possible |
| EpiLPS | Regression | Smooth | Yes | User-specified | Yes | No | No | No | No |
